...
import { t, getMonthName1 } from '../utils/i18n.js'
...
export async function InformesView() {
  ...
  for (let i = 5; i >= 0; i--) {
    ...
    monthlyData.push({
      ...
      label: getMonthName1(m).substring(0, 3)
    })
  }
      ...
      <div class="card">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="p-4 bg-dark-50 dark:bg-dark-800 rounded-xl">
            <p class="text-sm text-dark-500 dark:text-dark-400 mb-3 font-medium">${getMonthName1(mesAnterior)}</p>
            <div class="space-y-2">
          ...
          <div class="p-4 bg-primary-50 dark:bg-primary-900/20 rounded-xl border-2 border-primary-200 dark:border-primary-800">
            <p class="text-sm text-primary-600 dark:text-primary-400 mb-3 font-medium">${getMonthName1(mesActual)} (${t('reports.currentMonth')})</p>
            <div class="space-y-2">
              <div class="flex justify-between">
                <span class="text-success-600">${t('reports.income')}</span>
